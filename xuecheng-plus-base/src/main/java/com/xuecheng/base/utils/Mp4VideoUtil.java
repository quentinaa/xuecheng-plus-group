...
public class Mp4VideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "C:\\Program Files (x86)\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
...
//        Process p = builder.start();
        ...
        String ffmpeg_path = "C:\\Program Files (x86)\\ffmpeg\\ffmpeg.exe";//ffmpeg的安装位置
        //源avi视频的路径
        String video_path = "C:\\Users\\xzt\\Videos\\云.avi";
        //转换后mp4文件的名称
        String mp4_name = "yun01.mp4";
        //转换后mp4文件的路径
        String mp4_path = "C:\\Users\\xzt\\Videos\\yun01.mp4";
        //创建工具类对象
